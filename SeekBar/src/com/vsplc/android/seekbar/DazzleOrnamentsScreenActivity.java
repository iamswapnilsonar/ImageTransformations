...
public class DazzleOrnamentsScreenActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.v("DazzleOrnamentsScreenActivity : ", "Display width : "+m_DisplayWidth+
...
//		Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.img_earringfive);
//		getImageLayout(bmp);
		
//		m_ivtmpImage.buildDrawingCache();
//		bitmap = m_ivtmpImage.getDrawingCache();
//		
//		Log.v("onCreate ", "Bitmap : "+bitmap);
...
//
//				Log.v("onProgressChanged : ", " m_ivtmpImage :"+m_ivtmpImage);
//
//				m_ivtmpImage.setImageBitmap(rotateCommand.process(bitmap));
//
...
//		m_absTextlayout.addView(m_btnZoom);
		...
		m_ivtmpImage.setDrawingCacheEnabled(true);
		m_ivtmpImage.setClickable(true);
...
//		});
		...
		m_vtoTree = m_ivtmpImage.getViewTreeObserver();
		m_vtoTree.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {

			@Override
			public void onGlobalLayout() {
				m_ivtmpImage.getViewTreeObserver().removeGlobalOnLayoutListener(this);
			}
		});
...
//		m_absolutelayout.addView(m_absTextlayout);
		...
		m_absolutelayout.addView(m_ivtmpImage);
		...
		m_ivtmpImage.setOnTouchListener(m_touchImagListener);
